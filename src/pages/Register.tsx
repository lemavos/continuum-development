      ...
      <div className="container relative z-10 px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-screen">
          ...
          <motion.div
            ...
            className="relative h-[420px] lg:h-[540px] hidden lg:block order-first"
          >
            {/* Outer glow ring */}
            <div
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="relative space-y-5">
                ...
                <motion.div {...fadeUp(0.3)} className="space-y-2">
                  <Label htmlFor="username" className="text-xs text-[oklch(0.7_0.008_260)] uppercase tracking-wider font-medium">
                    Username
                  </Label>
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[oklch(0.72_0.14_195/0.6)]" />
                    <Input
                      id="username"
                      value={username}
                ...
                <motion.div {...fadeUp(0.4)} className="space-y-2">
                  ...
                  <p className="text-xs text-[oklch(0.5_0.008_260)]">Minimum 8 characters</p>
                </motion.div>
              ...
              {/* Features */}
              <motion.div {...fadeUp(0.5)} className="mt-8 space-y-3 pt-6 border-t border-[oklch(0.72_0.14_195/0.2)]">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[oklch(0.72_0.14_195)]" />
                  <span className="text-sm text-[oklch(0.7_0.008_260)]">Organize your knowledge graph</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[oklch(0.72_0.14_195)]" />
                  <span className="text-sm text-[oklch(0.7_0.008_260)]">Connect your thoughts instantly</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[oklch(0.72_0.14_195)]" />
                  <span className="text-sm text-[oklch(0.7_0.008_260)]">Free forever as you grow</span>
                </div>
              </motion.div>
            </motion.div>
